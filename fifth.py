...
if __name__ == '__main__':
    try:
        ...
        print("Chyba: Nebyl zadán název souboru.", file=sys.stderr)
        
    except FileNotFoundError:
        print(f"Chyba: Soubor '{sys.argv[1]}' nebyl nalezen.", file=sys.stderr)

    except Exception as e:
        print(f"Nastala neočekávaná chyba: {e}", file=sys.stderr)